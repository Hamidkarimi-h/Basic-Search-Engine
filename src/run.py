...
from src.textproc.text_process import (ConvertCase, RemoveDigit, RemovePunkt,
                                  RemoveSpace, TextPipeline)
from src.utills import print_success


class Search:
    def __init__(self, documents_path: Union[str, Path], stop_words: Union[str, Path] = None) -> None:
        """
